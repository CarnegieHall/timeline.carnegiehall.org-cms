...
class HeroFeaturedContentRepository extends ModuleRepository
{
    use HandleMedias, HandleRevisions, HasRelated;
    ...
    public function __construct(HeroFeaturedContent $model)
    {
        $this->model = $model;
    }
