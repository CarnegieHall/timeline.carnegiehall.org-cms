...
'additionalFieldsets' => [
['fieldset' => 'songs', 'label' => 'Songs'],
['fieldset' => 'influences', 'label' => 'Influences'],
['fieldset' => 'stories', 'label' => 'Stories'],
['fieldset' => 'notablePerformers', 'label' => 'Notable Performers'],
...
'blocks' => ['title', 'text', 'media-collection', 'block-quote', 'bibliography-collection']
])
...
{{-- <a17-fieldset title="Definition" id="title_text" :open="true">
  @formField('repeater', ['type' => 'title_text'])
</a17-fieldset> --}}
...
<a17-fieldset title="Musical Features" id="musicalFeatures">
  @formField('browser', [
  'moduleName' => 'more.musicalFeatures',
