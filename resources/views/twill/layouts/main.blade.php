...
<body class="env env--{{ app()->environment() }} @yield('appTypeClass')">
    <div class="svg-sprite">
        {!! File::exists(public_path('/assets/admin/icons/icons.svg'))
            ? File::get(public_path('/assets/admin/icons/icons.svg'))
            : '' !!}
        {!! File::exists(public_path('/assets/admin/icons/icons-files.svg'))
            ? File::get(public_path('/assets/admin/icons/icons-files.svg'))
            : '' !!}
    </div>
            ...
            <div class="app" id="app" v-cloak>
                ...
                @if (config('twill.enabled.media-library') || config('twill.enabled.file-library'))
                    <a17-medialibrary ref="mediaLibrary"
                        :authorized="{{ json_encode(auth('twill_users')->user()->can('edit')) }}"></a17-medialibrary>
