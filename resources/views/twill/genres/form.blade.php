...
@section('contentFields')
    ...
    @formField('block_editor', [
        'blocks' => ['title', 'text', 'media-collection', 'block-quote', 'bibliography-collection', 'related-genres', 'accordion', 'map'],
    ])
...
@section('sideFieldsets')
    ...
    @include('twill/_includes/api-link', ['name' => 'genres', 'entity' => $item->slug])
@endsection
