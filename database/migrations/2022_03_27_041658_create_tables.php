...
class CreateTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('genre_cross_genre', function (Blueprint $table) {
            $table->foreign(['genre_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
            $table->foreign(['cross_influence_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
        });

        Schema::table('genre_cross_influenced', function (Blueprint $table) {
            $table->foreign(['genre_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
            $table->foreign(['cross_influenced_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
        });

        Schema::table('genre_genre', function (Blueprint $table) {
            $table->foreign(['influence_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
            $table->foreign(['genre_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
        });

        Schema::table('genre_influenced', function (Blueprint $table) {
            $table->foreign(['influenced_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
            $table->foreign(['genre_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
        });
        ...
        Schema::table('genre_musical_feature', function (Blueprint $table) {
            $table->foreign(['musical_feature_id'])->references(['id'])->on('musical_features')->onDelete('CASCADE');
            $table->foreign(['genre_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
        });

        Schema::table('genre_notable_performer', function (Blueprint $table) {
            $table->foreign(['notable_performer_id'])->references(['id'])->on('notable_performers')->onDelete('CASCADE');
            $table->foreign(['genre_id'])->references(['id'])->on('genres')->onDelete('CASCADE');
        });

        Schema::table('genre_slugs', function (Blueprint $table) {
            $table->foreign(['genre_id'], 'fk_genre_slugs_genre_id')->references(['id'])->on('genres')->onDelete('CASCADE');
        });
        ...
        Schema::table('story_slugs', function (Blueprint $table) {
            $table->foreign(['story_id'], 'fk_story_slugs_story_id')->references(['id'])->on('stories')->onDelete('CASCADE');
        });
    ...
    public function down()
    {
        ...
        Schema::table('fileables', function (Blueprint $table) {
            $table->dropForeign('fk_files_file_id');
        });
